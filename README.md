...
See [`packaging/README.md`](packaging/README.md) for prerequisites, expected output, runtime data location, and known limitations. The prototype packages the GUI only; the CLI remains available from source with `python -m app.main ...`.
